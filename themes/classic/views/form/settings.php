...
use app\themes\classic\bundles\WysiwygBundle;
...
$this->registerJsFile('@web/themes/classic/assets/js/libs/jquery.textcomplete.min.js', ['depends' => WysiwygBundle::class]);

// Load form.settings.js after WysiwygBundle
$this->registerJsFile('@web/themes/classic/assets/js/form.settings.min.js', ['depends' => WysiwygBundle::class]);
                            ...
                            [
                                ...
                                'attributes' => [
                                    'event' => [
                                        ...
                                        'options' => [
                                            'data' => EventHelper::supportedFormEvents(['addons' => true]),
                                            'options' => [

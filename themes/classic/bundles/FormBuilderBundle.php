...
class FormBuilderBundle extends AssetBundle
{
    ...
    public function init()
    {
        if (YII_ENV_DEV) {
            ...
            $this->jsOptions['data-main'] = Yii::getAlias('@web') . "/themes/classic/assets/js/form.builder/main.js";
        } else {
            // For production
            // Full command. Run from the base directory.
            // r.js -o static_files/js/form.builder/lib/build.js optimize=none
            $this->jsOptions['data-main'] = Yii::getAlias('@web') . "/themes/classic/assets/js/form.builder/main-built.js";
        }
